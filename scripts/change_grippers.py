...
def main():
    ...
    rospy.loginfo('Please wait for sometime. Change grippers process should take %s seconds approximately.' % (sleep_duration * 2))
    ...
    cmds = [left_cmd, right_cmd]

    # source: https://stackoverflow.com/a/4791612
    for cmd in cmds:
        p = subprocess.Popen(cmd, shell=True, stderr=subprocess.PIPE, preexec_fn=os.setsid)
