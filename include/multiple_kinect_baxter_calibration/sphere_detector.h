...
RansacParams::RansacParams(int k_neighbors_ransac, int max_itr_ransac,
    double weight_ransac, double d_thresh_ransac, double prob_ransac,
    double tolerance_ransac, double epsilon_ransac) :
    k_neighbors(k_neighbors_ransac), max_itr(max_itr_ransac), weight(
        weight_ransac), d_thresh(d_thresh_ransac), prob(prob_ransac), tolerance(
        tolerance_ransac), epsilon(epsilon_ransac) {
}
