...
private:
  ...
  void
  recordSpherePositionWrtBaxter(const baxter_core_msgs::EndpointState ee_msg);
...
void DataCollector::recordSpherePositionWrtBaxter(
    const baxter_core_msgs::EndpointState ee_msg) {
...
// callback function for end-effector pose
void DataCollector::baxterEECallback(
...
DataCollector::DataCollector() {
  ...
  baxter_arm_sub = nh.subscribe(ee_topic, queue_size,
                                &DataCollector::baxterEECallback, this);
