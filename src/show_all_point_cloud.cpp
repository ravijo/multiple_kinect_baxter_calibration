/**
 * show_all_point_cloud.cpp: class file for visualizing the contribution of each kinect sensor
 * Author: Ravi Joshi
 * Date: 2018/04/04
 */
...
void ShowAllPointCloud::applyColor(pcl::PointCloud<pcl::PointXYZRGB>& cloud,
		uint32_t color) {
...
ShowAllPointCloud::ShowAllPointCloud() {
	...
	sync.registerCallback(
			boost::bind(&ShowAllPointCloud::callback, this, _1, _2, _3));

	ros::spin();
}

int main(int argc, char** argv) {
	ros::init(argc, argv, "show_all_point_cloud",
