...
{
  ros::init(argc, argv, "sphere_detector_test_node",
  ...
  else
  {
    ...
    ROS_WARN_STREAM("Sphere radius is not provided. Using "
                    << sphere_radius << " as default value");
  }
  ...
  {
    min_h = default_min_h;
    ROS_WARN_STREAM("Minimum hue is not provided. Using "
                    << min_h << " as default value");
  }
  ...
  {
    min_s = default_min_s;
    ROS_WARN_STREAM("Minimum saturation is not provided. Using "
                    << min_s << " as default value");
  }
  ...
  {
    min_v = default_min_v;
    ROS_WARN_STREAM("Minimum value is not provided. Using "
                    << min_v << " as default value");
  }
  ...
  {
    max_h = default_max_h;
    ROS_WARN_STREAM("Maximum hue is not provided. Using "
                    << max_h << " as default value");
  }
  ...
  {
    max_s = default_max_s;
    ROS_WARN_STREAM("Maximum saturation is not provided. Using "
                    << max_s << " as default value");
  }
  ...
  {
    max_v = default_max_v;
    ROS_WARN_STREAM("Maximum value is not provided. Using "
                    << max_v << " as default value");
  }
  ...
  pcl_utility::SphereDetector sphereDetector(sphere_radius, &min_hsv_values,
  ...
  if (status)
  {
    ...
    seg_viewer.addSphere(detected_sphere, sphere_coff.values[3], 0.2, 0.3, 1.0,
                         "detected_sphere");
    seg_viewer.addText3D("Sphere", detected_sphere, 0.05, 0.2, 0.3, 1.0,
                         "sphere_text");
  }
  else
  {
