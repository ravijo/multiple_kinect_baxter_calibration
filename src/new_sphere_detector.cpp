...
int main(int argc, char** argv) {
  ...
  std::string pcdFileName =
      "/home/tom/Documents/ravi/Recycle_Bin/no-light/frame_1_kinect_1.pcd";

  std::string cam_file =
      "/home/tom/ros_ws/src/multiple_kinect_baxter_calibration/files/libfreenect.cam";
  ...
  pcl::PointCloud<pcl::PointXYZRGB>::Ptr p1(
      new pcl::PointCloud<pcl::PointXYZRGB>);
  pcl::PointCloud<pcl::PointXYZRGB>::Ptr p2(
      new pcl::PointCloud<pcl::PointXYZRGB>);
  pcl::PointCloud<pcl::PointXYZRGB>::Ptr p3(
      new pcl::PointCloud<pcl::PointXYZRGB>);
  pcl::PointCloud<pcl::PointXYZRGB>::Ptr filtered_body(
      new pcl::PointCloud<pcl::PointXYZRGB>);
